...
bool checkValidProfile() {
  bool isValid = false;
  if (isNum(profileAge.text) &&
      isNum(profileWeight.text) &&
      isNum(profileHeight.text) &&
      isNum(profileCalories.text) &&
      isNum(profileProteins.text) &&
      isNum(profileFats.text) &&
      isNum(profileCarbs.text)) {
    isValid = true;
  }
  return isValid;
}
